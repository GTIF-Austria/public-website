import{v as l,C as p,c as d,o as m,G as u,j as f,k as v,g as _,q as s}from"./chunks/framework.BBfYy6Nl.js";const h=[".config"],y=JSON.parse('{"title":"","description":"","frontmatter":{"layout":false},"headers":[],"relativePath":"explore.md","filePath":"explore.md"}'),x={name:"explore.md"},b=Object.assign(x,{setup(w){function i(t){const o=setInterval(()=>{if(window.eodashStore){clearInterval(o),t(window.eodashStore);const e=document.querySelector("eo-dash"),a=document.createElement("style");a.textContent=`

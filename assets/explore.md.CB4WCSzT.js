import{v as c,C as d,c as p,o as m,G as u,j as v,k as f,g as h,q as s}from"./chunks/framework.DcHDDd1r.js";const x=[".config"],y=JSON.parse('{"title":"","description":"","frontmatter":{"layout":false},"headers":[],"relativePath":"explore.md","filePath":"explore.md"}'),_={name:"explore.md"},g=Object.assign(_,{setup(b){function i(t){const n=setInterval(()=>{if(window.eodashStore){clearInterval(n),t(window.eodashStore);const e=document.querySelector("eo-dash"),a=document.createElement("style");a.textContent=`

 ...
 */const Rr=ir(class extends rr{constructor(i){if(super(i),i.type!==Ot.PROPERTY&&i.type!==Ot.ATTRIBUTE&&i.type!==Ot.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!mn(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===Qt||t===tt)return t;const e=i.element,r=i.name;if(i.type===Ot.PROPERTY){if(t===e[r])return Qt}else if(i.type===Ot.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(r))return Qt}else if(i.type===Ot.ATTRIBUTE&&e.getAttribute(r)===t+"")return Qt;return yn(i),t}});var Pr="Expected a function",Ji=NaN,wa="[object Symbol]",xa=/^\s+|\s+$/g,Sa=/^[-+]0x[0-9a-f]+$/i,Ea=/^0b[01]+$/i,Ca=/^0o[0-7]+$/i,$a=parseInt,Ta=typeof Ut=="object"&&Ut&&Ut.Object===Object&&Ut,_a=typeof self=="object"&&self&&self.Object===Object&&self,Aa=Ta||_a||Function("return this")(),Da=Object.prototype,ka=Da.toString,La=Math.max,Ra=Math.min,gi=function(){return Aa.Date.now()};function Pa(i,t,e){var r,n,o,a,s,l,c=0,u=!1,d=!1,p=!0;if(typeof i!="function")throw new TypeError(Pr);t=Ki(t)||0,Pe(e)&&(u=!!e.leading,d="maxWait"in e,o=d?La(Ki(e.maxWait)||0,t):o,p="trailing"in e?!!e.trailing:p);function f(A){var G=r,dt=n;return r=n=void 0,c=A,a=i.apply(dt,G),a}function y(A){return c=A,s=setTimeout(B,t),u?f(A):a}function w(A){var G=A-l,dt=A-c,J=t-G;return d?Ra(J,o-dt):J}function k(A){var G=A-l,dt=A-c;return l===void 0||G>=t||G<0||d&&dt>=o}function B(){var A=gi();if(k(A))return D(A);s=setTimeout(B,w(A))}function D(A){return s=void 0,p&&r?f(A):(r=n=void 0,a)}function W(){s!==void 0&&clearTimeout(s),c=0,r=l=n=s=void 0}function M(){return s===void 0?a:D(gi())}function et(){var A=gi(),G=k(A);if(r=arguments,n=this,l=A,G){if(s===void 0)return y(l);if(d)return s=setTimeout(B,t),f(l)}return s===void 0&&(s=setTimeout(B,t)),a}return et.cancel=W,et.flush=M,et}function Ma(i,t,e){var r=!0,n=!0;if(typeof i!="function")throw new TypeError(Pr);return Pe(e)&&(r="leading"in e?!!e.leading:r,n="trailing"in e?!!e.trailing:n),Pa(i,t,{leading:r,maxWait:t,trailing:n})}function Pe(i){var t=typeof i;return!!i&&(t=="object"||t=="function")}function Oa(i){return!!i&&typeof i=="object"}function Ia(i){return typeof i=="symbol"||Oa(i)&&ka.call(i)==wa}function Ki(i){if(typeof i=="number")return i;if(Ia(i))return Ji;if(Pe(i)){var t=typeof i.valueOf=="function"?i.valueOf():i;i=Pe(t)?t+"":t}if(typeof i!="string")return i===0?i:+i;i=i.replace(xa,"");var e=Ea.test(i);return e||Ca.test(i)?$a(i.slice(2),e?2:8):Sa.test(i)?Ji:+i}var Va=Ma;const Qi=Ti(Va);/**
 * @license
 ...
 */const ve=i=>i??tt;var ct,Me,Oe;class Mr extends ot{constructor(){super();T(this,ct,[]);T(this,Me,$i`
      ...
      ${F(this.layerConfig,()=>m`
          ${F(this.layerConfig.legend,()=>m`
              <eox-layercontrol-layer-legend
                ...
                .layer=${this.layer}
                .layerLegend=${pa(this.layerConfig.legend,S(this,vt))}
              ></eox-layercontrol-layer-legend>
            `)}
  ...
  `);this.layer=null,this.tools=[],this.unstyled=!1,this.noShadow=!1,this.toolsAsList=!1}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){var l;const e=ga(this.tools,this.layer),r=ma(this.tools,this.layer),n=this[`_${e==null?void 0:e[0]}Button`]?this[`_${e==null?void 0:e[0]}Button`]():tt,o=((l=this.tools)==null?void 0:l.length)===1?`${this.tools[0]}-icon`:"",a=e==null?void 0:e.length,s=r==null?void 0:r.length;return m`
      <style>
        ${S(this,ze)}
  ...
  `);this.group=null,this.idProperty="id",this.map=null,this.titleProperty="title",this.showLayerZoomState=!1,this.tools=[],this.unstyled=!1,this.noShadow=!1,this.toolsAsList=!1}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){var n,o;const e=!!((n=this.group)!=null&&n.get("layerControlExpand")),r=(o=Lr(this.group.getLayers()))==null?void 0:o.length;return m`
      ...
      ${F(this.group,()=>m`
        ...
        `)}
    `}}Ze=new WeakMap,Xe=new WeakMap,O(zr,"properties",{group:{attribute:!1},idProperty:{attribute:"id-property"},map:{attribute:!1,state:!0},titleProperty:{attribute:"title-property",type:String},showLayerZoomState:{attribute:"show-layer-zoom-state",type:Boolean},tools:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean},toolsAsList:{type:Boolean}});customElements.define("eox-layercontrol-layer-group",zr);const Ha=i=>{const{layers:t,idProperty:e,titleProperty:r,renderRoot:n}=i,o=fn(()=>{i.requestUpdate(),i.dispatchEvent(new CustomEvent("changed",{bubbles:!0}))},50),a=()=>o();if(t&&(t.hasListener("change:length")&&(t==null||t.un("change:length",a)),t.on("change:length",a),t)){const s=n.querySelector("ul");sa(t,e,r,i),aa(s,t,e,i)}};var We,Ge;class jr extends ot{constructor(){super();T(this,We,"");T(this,Ge,`
    ul {
      padding: 0;
      margin: 0;
    }
  ...
  `);this.idProperty="id",this.layers=null,this.map=null,this.tools=void 0,this.titleProperty="title",this.showLayerZoomState=!1,this.unstyled=!1,this.noShadow=!1,this.toolsAsList=!1}firstUpdated(){Ha(this)}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){const e=this.layers?Lr(this.layers).reverse():[];return m`
    ...
    `}}Je=new WeakSet,Yr=function(){Fa(this)},O(qr,"properties",{idProperty:{attribute:"id-property"},layers:{attribute:!1},titleProperty:{attribute:"title-property",type:String},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-optional-list",qr);const Ua=(i,t)=>{t.jsonInput=i.target.value,t.requestUpdate()},tr=i=>{const t=JSON.parse(`{"data":${fr(i.jsonInput)}}`);Array.isArray(t.data)?t.data.forEach(e=>{i.eoxMap.addOrUpdateLayer(e)}):i.eoxMap.addOrUpdateLayer(t.data),i.jsonInput=null,i.requestUpdate()},za=(i,t)=>{t.urlInput=i.target.value,t.requestUpdate()};async function ja(i){const t=i.urlInput;if(i.wmsCapabilities=null,i.searchLoad=!0,i.requestUpdate(),!t)return!1;if(Ai(t)==="XYZ")return{Name:t};try{const e=await Do(t);i.wmsCapabilities=e}catch{}finally{i.searchLoad=!1,i.requestUpdate()}return!1}const qa=(i,t)=>{const{Name:e}=i,r=Ai(t.urlInput)||"XYZ",n={type:"Tile",properties:{id:e,title:e},source:{type:r,url:t.urlInput,params:{LAYERS:e}}};t.jsonInput=JSON.stringify(n)},Ya=(i,t)=>{t.open=i||null,t.urlInput=null,t.jsonInput=null,t.wmsCapabilities=null,t.requestUpdate()};var q,Xr,Wr,Ci,Gr,Jr,Te,Ke,Qe;class Zr extends ot{constructor(){super();T(this,q);O(this,"urlInput",null);O(this,"jsonInput",null);O(this,"open",null);O(this,"searchLoad",!1);O(this,"wmsCapabilities",null);T(this,Ke,`
  ...
  `);this.eoxMap=null,this.unstyled=!1,this.noShadow=!1}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){const e=this.open?"open":"close",r=this.open==="url",n=this.open==="json",o=!ko(this.urlInput)||this.searchLoad?!0:tt;return m`
      <style>
        ${S(this,Ke)}
          ...
          ${r?m`
            ...
            `:m`
                ...
                <button
                  ...
                  disabled=${Lo(this.jsonInput)?tt:!0}
                  @click=${R(this,q,Gr)}
                >
    ...
    `}}q=new WeakSet,Xr=function(e){za(e,this)},Wr=async function(){const e=await ja(this);e&&R(this,q,Ci).call(this,e)},Ci=function(e){qa(e,this),tr(this)},Gr=function(){tr(this)},Jr=function(e){Ua(e,this)},Te=function(e){Ya(e,this)},Ke=new WeakMap,Qe=new WeakMap,O(Zr,"properties",{eoxMap:{attribute:!1,state:!0},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-add-layers",Zr);const Za=(i,t)=>{if(t.requestUpdate(),i.target.tagName==="EOX-LAYERCONTROL-LAYER-TOOLS"){const e=t.renderRoot.querySelector("eox-layercontrol-optional-list");e==null||e.requestUpdate()}},er=i=>{const t=bi(i.for);return t&&t.map!==i.map&&(i.map=t.map),t};var Dt,Lt,Qr,tn,en,ti;class Kr extends ot{constructor(){super();T(this,Lt);T(this,Dt);T(this,ti,`
    :host, :root {

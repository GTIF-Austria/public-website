import{b as l,o as s,w as h,j as b,k as n,c as p,e as d,N as v,aC as g,H as w,K as y,F as x,B as _,T as k}from"./framework.CKdxjOfV.js";import{al as A,bm as $}from"./eo-dash.BtwWSFqU.js";import{V as B}from"./VMain-CZBY-fic.C28hLHMo.js";import"./commonjsHelpers.BosuxZz1.js";import"./ssrBoot-Zgc_Ttvi.BQ94O7Ee.js";class C extends HTMLElement{static get observedAttributes(){return["column-width","fill-grid","gap","row-height"]}constructor(){super(),this.mediaBreakpoints=[0,600,1280],this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {

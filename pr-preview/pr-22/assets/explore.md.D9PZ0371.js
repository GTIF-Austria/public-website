import{v as d,C as p,c as m,o as u,G as v,j as h,k as f,g as x,q as s}from"./chunks/framework.CiFwfEYM.js";const _=[".config"],y=JSON.parse('{"title":"","description":"","frontmatter":{"layout":false},"headers":[],"relativePath":"explore.md","filePath":"explore.md"}'),b={name:"explore.md"},B=Object.assign(b,{setup(w){function i(t){const n=setInterval(()=>{if(window.eodashStore){clearInterval(n),t(window.eodashStore);const e=document.querySelector("eo-dash"),a=document.createElement("style");a.textContent=`

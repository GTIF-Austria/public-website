var vo=Object.defineProperty;var cr=t=>{throw TypeError(t)};var wo=(t,e,n)=>e in t?vo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var Xt=(t,e,n)=>wo(t,typeof e!="symbol"?e+"":e,n),sn=(t,e,n)=>e.has(t)||cr("Cannot "+n);var G=(t,e,n)=>(sn(t,e,"read from private field"),n?n.call(t):e.get(t)),q=(t,e,n)=>e.has(t)?cr("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,n),be=(t,e,n,r)=>(sn(t,e,"write to private field"),r?r.call(t,n):e.set(t,n),n),S=(t,e,n)=>(sn(t,e,"access private method"),n);import{e as xo,a as Ao,b as it,E as vt,x as A}from"./addCommonStyleSheet.1KzE_Bhf.js";import{o as ve,a as Ne}from"./unsafe-html.BZ5OabsJ.js";import{n as j}from"./when.BR7zwNJC.js";import{d as Jt,c as _o}from"./repeat.DVUTREkw.js";import{_ as Ie}from"./index.BUIxO2d3.js";import{s as jt,u as ur}from"./static.BVv9v4BW.js";import"./toolcool-range-slider.min.BBXDELo7.js";import{o as Mo}from"./orient2d.DArCjZZA.js";import{f as Ce,a as un,b as Co,m as Lo,l as So}from"./index.BSpBAx16.js";import{g as Sr,c as bt}from"./commonjsHelpers.BosuxZz1.js";import"./directive.CvdRHFdJ.js";import"./directive-helpers.DSrqcGdr.js";const $o=`
:host {
  display: flex;

import{b as l,o as s,w as h,j as b,k as n,c as p,e as d,N as v,aC as g,H as w,K as y,F as x,B as _,T as k}from"./framework.BrtfRGrB.js";import{al as A,bm as $}from"./eo-dash.B2Y-XyZL.js";import{V as B}from"./VMain-CZBY-fic.BcijkY24.js";import"./commonjsHelpers.BosuxZz1.js";import"./ssrBoot-Zgc_Ttvi.C7IApR-E.js";class C extends HTMLElement{static get observedAttributes(){return["column-width","fill-grid","gap","row-height"]}constructor(){super(),this.mediaBreakpoints=[0,600,1280],this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
...
`)}
      ...
      <slot></slot>
    `}attributeChangedCallback(t,i,a){i!==a&&(this[t]=a),this.render()}}customElements.define("eox-layout",C);customElements.define("eox-layout-item",E);const L=["gap"],S=["id","h","w","x","y"],T={__name:"DashboardLayout",setup(m){const{bgWidget:t,importedWidgets:i,gap:a}=$(),o={padding:a.value+"px",overflow:"hidden !important"};return(r,f)=>(s(),l(B,null,{default:h(()=>{var c;return[b("eox-layout",{gap:n(a),class:"layout-container",style:o},[(c=n(t))!=null&&c.component?(s(),p("eox-layout-item",{key:n(t).id,class:"bg-panel bg-surface",style:v(`margin: -${n(a)+1}px;`),x:"0",y:"0",h:"12",w:"12"},[(s(),l(g,null,{default:h(()=>{var e,u;return[(s(),l(w((e=n(t))==null?void 0:e.component),y({id:"bg-widget"},(u=n(t))==null?void 0:u.props),null,16))]}),_:1}))],4)):d("v-if",!0),(s(!0),p(x,null,_(n(i),(e,u)=>(s(),l(k,{key:u,name:"fade"},{default:h(()=>[e.value.component?(s(),p("eox-layout-item",{id:e.value.id.toString(),key:e.value.id,class:"panel bg-surface",h:e.value.layout.h,w:e.value.layout.w,x:e.value.layout.x,y:e.value.layout.y},[(s(),l(g,null,{default:h(()=>[(s(),l(w(e.value.component),y({key:e.value.id,ref_for:!0},e.value.props),null,16))]),_:2},1024))],8,S)):d("v-if",!0)]),_:2},1024))),128))],8,L)]}),_:1}))}},N=A(T,[["__scopeId","data-v-77ee454d"]]);export{N as default};
